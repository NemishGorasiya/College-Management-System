...
export const generateFinalResultPdf = (data) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            doc.y = doc.page.height - 170; //move to the footer
            ...
            doc.moveTo(0, doc.y)
                ...
                .stroke();
            doc.y = doc.y + 10;
            doc.fontSize(12).text('Generated by: College Management System', { align: 'center' });
            doc.y = doc.y + 10;
            doc.fontSize(12).text(`Generated at: ${format(new Date(), "dd-MM-yyyy HH:mm:ss")}`, { align: 'center' });

            doc.y = doc.y + 10;
            doc.fontSize(12).text(`Generated for ${user.fullName} with email: ${user.email}`, { align: 'center' });
