...
export default function PlacementSlider() {
  ...
  return (
    <div name="placements" className="bg-white rounded-lg p-2 my-[2rem]">
          ...
          return (
            <SwiperSlide key={index}>
              <div className="bg-white rounded-lg p-2 my-[2rem] border-2 border-stone-800 flex flex-col items-center justify-center">
                <img src={`https://ldce.ac.in/upload/logo/company/${item.fileName}`} alt={item.name} className="w-[50%] object-cover" style={{ maxHeight: '500px' }} />
